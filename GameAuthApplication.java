...
public class GameAuthApplication extends Application<Configuration> {
	...
	public void run(Configuration c, Environment e) throws Exception 
	{
		...
		final Client demoRESTClient = new JerseyClientBuilder(e).build("DemoRESTClient");

 
		// Registered GameUserRESTController (based on BasicAuth Security Example)
		// Created io.dropwizard.client.JerseyClientBuilder instance and give it io.dropwizard.setup.Environment reference (based on BasicAuth Security Example)
